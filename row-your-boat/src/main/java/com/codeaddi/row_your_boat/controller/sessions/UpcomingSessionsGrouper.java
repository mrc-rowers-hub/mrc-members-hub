...
public class UpcomingSessionsGrouper {
    ...
    public static Map<UpcomingSessionsGrouper.UpcomingSessionKey, List<UpcomingAvailabilityDTO>> groupSessions(
            List<UpcomingAvailabilityDTO> upcomingSession) {
        return upcomingSession.stream()
                .collect(Collectors.groupingBy(UpcomingSessionKey::new));
    }
    ...
    public static class UpcomingSessionKey {
        ...
        public boolean equals(Object o) {
            ...
            UpcomingSessionsGrouper.UpcomingSessionKey that = (UpcomingSessionsGrouper.UpcomingSessionKey) o;
